...
/**
 * @brief When the user closes the main window.
 * @param event The close window event, ignored.
 */
 ...
 *
 * Update the title label every second, display a warning message if a
 * certain abount fo seconds passed.
 */
